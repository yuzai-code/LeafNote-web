<template>
    <div class="flex h-full">
        ...
        <!-- 分割线 -->
        <div class="w-1 hover:bg-primary/20 cursor-col-resize relative group"
             @mousedown="startResize">
            <!-- 拖动时的视觉提示 -->
            <div class="absolute inset-y-0 w-1 bg-primary/0 group-hover:bg-primary/20 transition-colors"></div>
        </div>
                        ...
                        <div class="flex justify-between items-center mt-2">
                            ...
                            <div class="flex gap-2">
                                ...
                                <span v-for="tag in note.tags" :key="tag" 
                                      class="badge badge-ghost">{{ tag }}</span>
                            </div>
                        </div>
                    </div>
                </div>
...
const notes = [
    {
        ...
        excerpt: '组合式 API 是 Vue3 中一个重要的新特性，它允许我们使用函数式的方式来组织组件的逻辑...',
        date: '2024-03-15',
        category: '前端开发',
    ...
    },
    {
        ...
        excerpt: 'TypeScript 的类型系统非常强大，本文深入探讨了泛型、映射类型和条件类型等高级特性...',
        date: '2024-03-12',
        category: '编程语言',
